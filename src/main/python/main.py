...
from pins import LASER_PIN, LIMIT_SWITCH_OPEN_PIN, LIMIT_SWITCH_CLOSE_PIN, DS18x20_PIN
...
sct_task = SmartCollarTemperatureTask(mqtt_manager=mqtt_manager, topic=MQTT_FOOD_TOPIC, tmp_pin=DS18x20_PIN, using_ds18x20=True)

# array of tasks
print("Creating array of tasks")
tasks = [sct_task.get_behaviour()]  # array of coroutines
